...
- Console Color initializes a fixed palette of 8 basic colors and their 8 brighter counter-parts (16 colors in total that the console is able to use). These can be utilized in writes directly to the console.  
