/*!
TestSuite\unit_tests.cpp
Created: October 21, 2025
Updated: October 27, 2025
Copyright (c) 2025, Jacob Gosse

Unit Tests source file.
*/
...
TEST_CASE(ut_math_05, "Math Tests", "Exponential Value")
{
	/* Exp */
...
TEST_CASE(ut_math_10, "Math Tests", "Lesser of Two Values (Min)")
{
	/* Min */
...
TEST_CASE(ut_math_11, "Math Tests", "Greater of Two Values (Max)")
{
	/* Max */
...
TEST_CASE(ut_math_14, "Math Tests", "ModBinomialSmall")
{
	/* ModBinomialSmall */
...
TEST_CASE(ut_math_15, "Math Tests", "ModBinomial")
{
	/* ModBinomial */
...
TEST_CASE(ut_math_16, "Math Tests", "Exponentiation by Squaring")
{
	/* Powers */
...
TEST_CASE(ut_math_17, "Math Tests", "Fibonacci")
{
	...
	for (int n = 0; n <= 93; ++n)
	{
		...
		if (n >= 2)
		{
			CHECK(fn == Fibonacci(n - 1) + Fibonacci(n - 2));
		}
...
TEST_CASE(ut_math_18, "Math Tests", "Sum")
{
	/* Sum */
...
TEST_CASE(ut_math_19, "Math Tests", "SumSquares")
{
	/* SumSquares */
