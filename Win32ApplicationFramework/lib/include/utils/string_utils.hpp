...
constexpr std::wstring ToWide(std::string_view string)
{
...
constexpr std::wstring ToWide(const char* string)
{
    return ToWide(std::string_view(string));
}
constexpr std::wstring ToWide(const std::string& string)
{
    return ToWide(std::string_view(string));
}
#pragma endregion
...
constexpr std::string ToNarrow(std::wstring_view wideString)
{
...
constexpr std::string ToNarrow(const wchar_t* wideString)
{
    return ToNarrow(std::wstring_view(wideString));
}
constexpr std::string ToNarrow(const std::wstring& wideString)
{
    return ToNarrow(std::wstring_view(wideString));
}
#pragma endregion
