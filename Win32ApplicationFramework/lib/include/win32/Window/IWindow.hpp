...
namespace winxframe
{
    ...
    */
    ...
    private:
        ...
        /**
        * @brief	Callback function to process event messages sent to a window.
        ...
        * @return	LRESULT DefWindowProc(hWnd, uMsg, wParam, lParam) or LRESULT HandleMessage(uMsg, wParam, lParam)
        */
        static LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);

        /**
        * @brief	Clean and release any other internal resources unassociated with the window handle.
        */
        void Cleanup();

    protected:
        /**
        * @brief	Virtual method called in WM_CREATE to encapsulate logic that should occur on window creation. Override in a derived class.
        * @return	0 on success, nonzero or -1 may indicate error or failure.
        */
        virtual LRESULT OnCreate() = 0;

        /**
        * @brief	Virtual method called in WM_DESTROY to encapsulate logic that should occur on window destruction. Override in a derived class.
        * @return	0 on success, nonzero or -1 may indicate error or failure.
        */
        ...
        * @param    const std::wstring& windowClassName         : Name of the window class (WNDCLASSEX).
        ...
        * @return	TRUE if window handle valid, FALSE otherwise.
        */
        bool Create(
    ...
    public:
        ...
        * @param	HINSTANCE hInstance  : A handle to the instance module.
        * @param	MessagePumpMode mode : Real-time or event-driven mode.
        */
        ...
        */
        ...
        /**
        * @brief    Return a boolean value based on the window handle being valid or not.
        ...
        * @return   Real-time or event-driven pump mode.
        */
